            ...
            <div className="p-8">
                <form className="space-y-6">
                        ...
                        <div className="group">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    <svg className="w-5 h-5 text-gray-400 group-focus-within:text-[#28295F] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="group">
                        ...
                        <div className="relative">
                            <select className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-[#28295F] focus:bg-white transition-all duration-300 appearance-none cursor-pointer">
                    ...
                    <div className="text-center pt-4">
                        <p className="text-sm text-gray-500 flex items-center justify-center gap-2">
                            ...
                            Respuesta garantizada en menos de 10  hora
                        </p>
                    </div>
                </form>
            </div>
