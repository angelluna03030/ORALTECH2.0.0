...
export const Informacion = () => {
  return (
      ...
      style={{
        background: "linear-gradient(90deg, rgba(21, 108, 175, 1) 0%, rgba(70, 190, 240, 1) 100%)",
      }}
    >
            ...
            <div key={index} className="flex flex-col items-center text-center">
              ...
              <div className="mb-2">
                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-none">
                  <CountUp end={stat.cantidad} duration={1000} suffix={stat.suffix} />
                  <br />
                   <p className="text-white text-sm flex sm:text-base md:text-lg mr-12 font-semibold">{stat.descripcion}</p> 
                </h2>
